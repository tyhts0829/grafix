...
laplace_field_grid_meta = {
    ...
    "u_min": ParamMeta(kind="float", ui_min=-10.0, ui_max=10.0),
    "u_max": ParamMeta(kind="float", ui_min=-10.0, ui_max=10.0),
    "v_min": ParamMeta(kind="float", ui_min=-10.0, ui_max=10.0),
    "v_max": ParamMeta(kind="float", ui_min=-10.0, ui_max=10.0),
    "n_u": ParamMeta(kind="int", ui_min=0, ui_max=200),
    "n_v": ParamMeta(kind="int", ui_min=0, ui_max=200),
    "samples": ParamMeta(kind="int", ui_min=2, ui_max=4000),
    "center": ParamMeta(kind="vec3", ui_min=0.0, ui_max=300.0),
    "scale": ParamMeta(kind="float", ui_min=0.0, ui_max=200.0),
    "rotate": ParamMeta(kind="float", ui_min=0.0, ui_max=360.0),
    "clip": ParamMeta(kind="bool"),
    "clip_xmin": ParamMeta(kind="float", ui_min=-200.0, ui_max=200.0),
    "clip_xmax": ParamMeta(kind="float", ui_min=-200.0, ui_max=200.0),
    "clip_ymin": ParamMeta(kind="float", ui_min=-200.0, ui_max=200.0),
    "clip_ymax": ParamMeta(kind="float", ui_min=-200.0, ui_max=200.0),
    # --- cylinder_uniform ---
    "a": ParamMeta(kind="float", ui_min=0.0, ui_max=50.0),
    "U": ParamMeta(kind="float", ui_min=0.0, ui_max=5.0),
    "gap": ParamMeta(kind="float", ui_min=0.0, ui_max=0.05),
    "draw_boundary": ParamMeta(kind="bool"),
    "boundary_samples": ParamMeta(kind="int", ui_min=3, ui_max=4000),
    # --- mobius ---
    "alpha_re": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    "alpha_im": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    "beta_re": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    "beta_im": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    "gamma_re": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    "gamma_im": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    "delta_re": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    "delta_im": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    # --- exp ---
    "k_re": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
    "k_im": ParamMeta(kind="float", ui_min=-5.0, ui_max=5.0),
}
