"""
どこで: tests/manual/test_parameter_gui_int_slider.py。
何を: `src/app/parameter_gui.py` の int スライダーを 1 行だけ表示する手動スモーク。
なぜ: kind=int のディスパッチとテーブルの挙動を 1 行ずつデバッグ確認するため。
"""
...
def main() -> None:
    ...
    run_pyglet_imgui(
        draw_ui,
        caption="parameter gui smoke (int slider)",
        width=800,
        height=240,
    )
