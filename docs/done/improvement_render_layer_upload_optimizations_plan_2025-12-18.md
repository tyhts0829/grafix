...
改善前の perf record
(gl5)  Graft % GRAFT_PERF=1 GRAFT_PERF_EVERY=60 python sketch/perf_sketch.py
...
(gl5)  Graft % GRAFT_PERF=1 GRAFT_PERF_EVERY=60 GRAFT_PERF_GPU_FINISH=1 python sketch/perf_sketch.py
