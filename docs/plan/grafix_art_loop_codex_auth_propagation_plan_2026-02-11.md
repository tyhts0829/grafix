...
> 注: 本計画は nested child artist の `CODEX_HOME` 分離を前提としていたため、現行運用では採用しない。現行方針は [local_artist_primary_migration_plan_2026-03-07.md](local_artist_primary_migration_plan_2026-03-07.md) を参照。
